...
const sfdcSwaggerGetAccountsSchema = require('./assets/sfdcSwagger.getAccounts.schema');
const sfdcSwaggerCreateAccountSchema = require('./assets/sfdcSwagger.createAccount.schema');
const sfdcSwaggerCreateAccountDefinitionSchema = require('./assets/sfdcSwagger.createAccount.definitions.schema');
...
suite.forPlatform('elements/instances', opts, (test) => {
  ...
  it('should support get instance specific docs', () => {
    return cloud.post(`instances/${sfdcId}/objects/myaccounts/definitions`, objDefPayload)
      ...
      .then(r => cloud.get(`instances/${sfdcId}/docs/getAccounts`, sfdcSwaggerGetAccountsSchema))
      .then(r => cloud.get(`instances/${sfdcId}/docs/createAccount`, sfdcSwaggerCreateAccountSchema))
      .then(r => cloud.get(`instances/${sfdcId}/docs/createAccount/definitions`, sfdcSwaggerCreateAccountDefinitionSchema))
      .then(r => cloud.get(`instances/${sfdcId}/docs/createAccount/definitions?discovery=true`, sfdcSwaggerCreateAccountDefinitionSchema));
  });
