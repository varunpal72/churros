...
const payload = tools.requirePayload(`${__dirname}/assets/purchase-orders.json`);


suite.forElement('finance', 'purchase-orders', { payload: payload, skip:true }, (test) => {//payload not working
