...
suite.forElement('documents', 'polling', null, (test) => {
  test.withApi('/hubs/documents/folders').should.supportPolling(foldersPayload, 'changes');
  test.withApi('/hubs/documents/files').should.supportPolling(filesPath, 'changes', addFile);
});
