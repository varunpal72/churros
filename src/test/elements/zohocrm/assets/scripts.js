...
module.exports = (element, method) => {
  ...
  switch (method) {
    case 'before':
      ...
      browser.switchTo().frame('zohoiam');
      browser.sleep(1500);
      ...
      browser.sleep(3000);
      browser.findElement(webdriver.By.xpath('//*[@id="trow"]/td[1]/a')).click();
      browser.findElement(webdriver.By.xpath('//*[@id="headerdiv"]/div')).click();
      browser.findElement(webdriver.By.className('saveBtn')).click();
