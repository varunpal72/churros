...
tester.forElement('documents', 'files', null, schema, (suite) => {
  it('should allow uploading and downloading a file', () => {
    ...
    return tester.postFile(suite.api, path, schema, { qs: query })
      .then(r => fileId = r.body.id)
      .then(r => tester.get(suite.api + '/' + fileId, (r) => expect(r).to.have.statusCode(200)))
