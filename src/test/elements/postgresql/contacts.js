...
suite.forElement('db', 'contacts', { payload: payload }, (test) => {
  ...
  const metaData = { "primaryKeyName": "contact_id" };
  ...
  const metaData2 = { "action": "upsert", "primaryKeyName": "contact_id" };
  ...
  const metaData3 = { "action": "upsert", "primaryKeyName": "contact_id", "bulkUploadRecordSize": 1 };
