...
// Test for extending sfdcdocuments and invoking the extended resource
suite.forElement('documents', 'extended-resource', {}, (test) => {
  let newResourceId;
  // Add resource to
  before(() => cloud.post(`elements/sfdcdocuments/resources`, newResource)
    .then(r => newResourceId = r.body.id));

  //delete new/overide resource should work fine
  after(() => cloud.delete(`elements/sfdcdocuments/resources/${newResourceId}`));
