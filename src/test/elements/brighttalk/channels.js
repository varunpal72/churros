...
suite.forElement('marketing', 'channels', null , (test) => {
    let channelId;
    it('should support GET,Pagination and CeqlSearch for /hubs/marketing/channels ', () => {
    ...
    it('should support GET,Pagination and CeqlSearch for /hubs/marketing/channels/:channelId/activities ', () => {
    let id;
    ...
    it('should support GET,Pagination and CeqlSearch for /hubs/marketing/channels/:channelId/contacts ', () => {
    let id;
    ...
    it('should support GET,Pagination and CeqlSearch for /hubs/marketing/channels/:channelId/subscriberWebcastAttachmentAccessSummaries ', () => {
    let id;
    ...
    it('should support GET,Pagination and CeqlSearch for /hubs/marketing/channels/:channelId/surveys  and /hubs/marketing/surveys/:surveyId/responses ', () => {
    let surveyId, id;
