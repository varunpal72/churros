...
const manipulateDom = (element, browser, r, username, password, config) => {
  switch (element) {
    ...
    case 'sfdclibraries':
      ...
      browser.findElement(webdriver.By.id('password')).sendKeys(password);
      browser.findElement(webdriver.By.id('Login')).click();
      browser.wait(() => browser.isElementPresent(webdriver.By.id('oaapprove')), 50000)
        .thenCatch(r => true); // ignore
    ...
    case 'sage200':
      ...
      case 'sageonev3':
        ...
        browser.get(r.body.oauthUrl);
        browser.wait(() => browser.isElementPresent(webdriver.By.id('ukflag')), 5000)
          .thenCatch(r => true); // ignore
        browser.findElement(webdriver.By.id('ukflag'))
          .then((element) => element.click(), (err) => {}); // ignore this
        browser.wait(() => {
